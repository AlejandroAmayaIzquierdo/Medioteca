        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProfilePicId = table.Column<Guid>(type: "TEXT", nullable: true),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, true, "Administrator role with full access", "Admin" },
                    { 2, true, "Regular user that can play daily challenges", "User" },
                    { 3, true, "Moderator that can create/edit challenges but not full admin", "Moderator" }
                });
